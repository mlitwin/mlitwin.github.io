...
* Some of it's pedagogical potential can be seen in it's [construction tools](https://geometricfunctions.org/fc/tools/) or [pre constructed activites](https://illuminations.nctm.org/wsp/).
