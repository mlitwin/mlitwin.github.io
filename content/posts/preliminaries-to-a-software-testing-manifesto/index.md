...
At a high level, I'll try to break down what software tests are, why we use them, and try to elucidate the terminology used in describing the kinds and properties of various forms of testing.
...
Generally you run a group of tests together, and consider the totality of the results - a "Test Suite"
...
* [Test Suite, Test Case Suite, Test Set] - A set of test scripts or test procedures to be executed in a specific test run.
